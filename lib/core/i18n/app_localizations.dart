...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    ...
    'briefing_action_risk': {'en': 'Risk radar', 'ar': 'رادار المخاطر'},
    ...
    'risk_dashboard_tagline': {
      'en': "Track exposures and opportunities from today's signals.",
      'ar': 'تابع التعرضات والفرص من إشارات اليوم.',
    },
    'risk_info_tooltip': {'en': 'How risk scores are built', 'ar': 'كيفية بناء درجات المخاطر'},
    'risk_info_title': {'en': 'About risk intelligence', 'ar': 'حول استخبارات المخاطر'},
    'risk_info_body': {
      'en':
          'Signals are generated locally by analyzing politics, culture, world events, and your collection to surface emerging exposure and action paths.',
      'ar':
          'يتم إنشاء الإشارات محليًا بتحليل السياسة والثقافة والأحداث العالمية ومقتنياتك للكشف عن التعرضات الناشئة ومسارات التصرف.',
    },
    'risk_average_title': {'en': 'Average severity', 'ar': 'متوسط الشدة'},
    'risk_average_value': {
      'en': '{value}% overall risk pressure',
      'ar': '{value}% ضغط المخاطر العام',
    },
    'risk_overview_counts': {
      'en': '{signals} signals • {watch} on watchlist',
      'ar': '{signals} إشارات • {watch} في قائمة المتابعة',
    },
    'risk_heatmap_empty': {
      'en': 'Heat map populates as signals arrive.',
      'ar': 'سيتم ملء خريطة الشدة مع وصول الإشارات.',
    },
    'risk_heatmap_title': {'en': 'Category heat map', 'ar': 'خريطة حرارة الفئات'},
    'risk_action_title': {'en': 'Suggested playbooks', 'ar': 'خطط مقترحة'},
    'risk_watchlist_title': {'en': 'Watchlist', 'ar': 'قائمة المراقبة'},
    'risk_empty_state': {
      'en': "No risk signals yet. Keep monitoring today's digest and collection.",
      'ar': 'لا توجد إشارات مخاطر بعد. تابع مراقبة ملخص اليوم ومقتنياتك.',
    },
    'risk_momentum_title': {'en': 'Momentum by category', 'ar': 'الزخم حسب الفئة'},
    'risk_related_assets': {'en': 'Linked assets', 'ar': 'الأصول المرتبطة'},
    'risk_preview_summary': {
      'en': '{value}% average severity across {count} spotlight signals.',
      'ar': '{value}% متوسط الشدة عبر {count} إشارات مميزة.',
    },
    'risk_preview_actions_label': {'en': 'Immediate next steps', 'ar': 'الخطوات التالية الفورية'},
    'risk_preview_highlights': {'en': 'Spotlight signals', 'ar': 'إشارات مميزة'},
    'risk_category_political': {'en': 'Political', 'ar': 'سياسي'},
    'risk_category_economic': {'en': 'Economic', 'ar': 'اقتصادي'},
    'risk_category_cultural': {'en': 'Cultural', 'ar': 'ثقافي'},
    'risk_category_security': {'en': 'Security', 'ar': 'أمني'},
    'risk_category_supply': {'en': 'Supply', 'ar': 'الإمدادات'},
    'risk_category_climate': {'en': 'Climate', 'ar': 'المناخ'},
    'risk_category_social': {'en': 'Social', 'ar': 'اجتماعي'},
    'risk_signal_governance': {'en': 'Governance volatility', 'ar': 'تقلبات الحوكمة'},
    'risk_summary_governance': {
      'en': 'Political headlines are spiking — expect rapid policy shifts and diplomatic ripples.',
      'ar': 'عناوين السياسة تتصاعد — توقَّع تحولات سريعة في السياسات وآثارًا دبلوماسية.',
    },
    'risk_signal_culture': {'en': 'Cultural momentum', 'ar': 'زخم ثقافي'},
    'risk_summary_culture': {
      'en': 'Arts and culture stories are accelerating, signaling soft-power opportunities.',
      'ar': 'قصص الفنون والثقافة تتسارع، مما يشير إلى فرص القوة الناعمة.',
    },
    'risk_signal_security': {'en': 'Geopolitical friction', 'ar': 'احتكاك جيوسياسي'},
    'risk_summary_security': {
      'en': 'Global developments point to elevated security considerations across regions.',
      'ar': 'التطورات العالمية تشير إلى ارتفاع الاعتبارات الأمنية عبر المناطق.',
    },
    'risk_signal_economy': {'en': 'Energy & economy pressure', 'ar': 'ضغط الطاقة والاقتصاد'},
    'risk_summary_economy': {
      'en': 'Economic and energy keywords are trending; watch pricing and supply implications.',
      'ar': 'الكلمات المفتاحية الاقتصادية والطاقوية تتصدر؛ راقب آثار الأسعار والإمدادات.',
    },
    'risk_signal_supply': {'en': 'Inventory sensitivity', 'ar': 'حساسية المخزون'},
    'risk_summary_supply': {
      'en': 'For-sale collectibles depend on limited sources. Adjust holding strategy.',
      'ar': 'المقتنيات المعروضة للبيع تعتمد على مصادر محدودة. عدل إستراتيجية الاحتفاظ.',
    },
    'risk_signal_social': {'en': 'Community sentiment shifts', 'ar': 'تحولات المزاج المجتمعي'},
    'risk_summary_social': {
      'en': 'Community-driven events suggest shifts in sentiment worth capturing.',
      'ar': 'الأحداث المجتمعية توحي بتحولات في المزاج تستحق الالتقاط.',
    },
    'risk_signal_climate': {'en': 'Climate disruption alerts', 'ar': 'تنبيهات اضطرابات مناخية'},
    'risk_summary_climate': {
      'en': 'Environmental signals indicate preparedness actions should activate now.',
      'ar': 'الإشارات البيئية تشير إلى ضرورة تفعيل إجراءات الاستعداد الآن.',
    },
    'risk_signal_baseline': {'en': 'Baseline monitoring', 'ar': 'مراقبة أساسية'},
    'risk_summary_baseline': {
      'en': 'No elevated patterns detected. Continue monitoring for new signals.',
      'ar': 'لم تُكتشف أنماط مرتفعة. واصل المراقبة بحثًا عن إشارات جديدة.',
    },
    'action_focus_primary': {'en': 'Focus on primary stakeholders', 'ar': 'ركّز على أصحاب المصلحة الرئيسيين'},
    'action_review_supply': {'en': 'Review supply posture', 'ar': 'راجع وضع الإمدادات'},
    'action_optimize_inventory': {'en': 'Optimize inventory mix', 'ar': 'حسّن مزيج المخزون'},
    'action_engage_community': {'en': 'Engage community leads', 'ar': 'تواصل مع قادة المجتمع'},
    'action_prepare_response': {'en': 'Prepare rapid response kit', 'ar': 'أعد تجهيزات استجابة سريعة'},
    'action_monitor_general': {'en': 'Monitor general sentiment', 'ar': 'راقب المزاج العام'},
    'risk_timeframe_next72': {'en': 'Next 72 hours', 'ar': 'الـ72 ساعة القادمة'},
    'risk_timeframe_quarter': {'en': 'This quarter', 'ar': 'هذا الربع'},
    'risk_timeframe_inventory': {'en': 'Inventory cycle', 'ar': 'دورة المخزون'},
    'risk_timeframe_weekend': {'en': 'Weekend focus', 'ar': 'تركيز نهاية الأسبوع'},
    'risk_timeframe_immediate': {'en': 'Immediate action', 'ar': 'إجراء فوري'},
    'risk_timeframe_today': {'en': 'Today', 'ar': 'اليوم'},
