...
class SettingsController extends ChangeNotifier {
  ...
  Future<String> backupToJson() => _prefs.exportBackup();

  Future<void> restoreFromJson(String json) async {
    await _prefs.restoreBackup(json);
    await load();
  }

  Future<void> resetToDefaults() async {
    await _prefs.setThemeMode(ThemeMode.system);
    await _prefs.setLocale(const Locale('en'));
    await _prefs.clearPrimaryColor();
